...
/*
        ...
        auto variable =
            std::make_shared<ov::op::util::Variable>(ov::op::util::VariableInfo{param->get_partial_shape(), param->get_element_type(), var_name});
