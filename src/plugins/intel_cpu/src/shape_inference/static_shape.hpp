...
using StaticShapeRef = StaticShapeAdapter<const std::vector<size_t>>;
using StaticShape = StaticShapeAdapter<std::vector<size_t>>;
 ...
 */
template <>
class StaticShapeAdapter<std::vector<size_t>> {
    using TDims = std::vector<size_t>;
 ...
 */
template <>
class StaticShapeAdapter<const std::vector<size_t>> {
    using TDims = std::vector<size_t>;
    using dim_type = typename TDims::value_type;
